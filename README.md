...
ButterLib, MCM, UIExtenderEx, BLSE) are excluded. Colours: red — incompatible build,
yellow — Harmony conflict / load order, orange — missing dependency, grey — disabled.

### 🔬 Crash diagnosis
Scans `C:\ProgramData\Mount and Blade II Bannerlord\crashes\` and the BUTR HTML
crash reports if you have BLSE/ButterLib. Matches every crash against **124 YAML
rules** covering:
...
### 🛠 System tune-up
**27 semi-automatic remediation modules**. Each card: Detect → Preview (diff)
...
- **Диагностика крашей** — **124 YAML-правила** под GPU/DirectX (включая авторитетный
