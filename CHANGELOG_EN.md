...
## 2026-06-16 — New guards: troops with "broken" data (no culture / upgrade list), a troop-training crash, the retreat victory cheer, and a save crash from a mod conflict
...
- **Plus new diagnostic rules** — all of these crashes are now recognized automatically and point at the root (corrupted troop data, or a mod conflict in the save data) in the report, not at shaders or drivers.
