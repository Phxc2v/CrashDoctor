...
- F1: ранний выход почасового тика для далёких невидимых отрядов (самый большой выигрыш FPS)
- F2: распределение тиков городов/замков (деревни не трогаем, продовольствие в порядке)
- F3: ограничение AI-тиков далёких отрядов до 2 Hz
- F4: прореживание визуальных кадров далёких отрядов (по умолчанию OFF — риск флика)
- F5: внутриигровой HUD со статистикой троттлинга, hotkey **Ctrl+O**, EN/RU (default EN)
